...
export default function MealCard({ type, menuItem, token, isPast, onBook, onCancel, loading }: MealCardProps) {
  const config =
    {
      1: {
        name: "Breakfast",
    ...
    >
      ...
      <div className="p-5 sm:p-6 flex-1 flex flex-col">
        ...
        <button
            ...
            disabled={isCancelled || isPast || loading || !isMenuAvailable}
            className={`px-5 sm:px-6 py-3 rounded-xl font-semibold text-sm transition-all flex items-center gap-2 ${
              isPast
